        ...
        <div className="flex-1 flex flex-col pt-16 overflow-hidden">
          ...
          <div className="px-4 pb-2">
            ...
            <div className="flex gap-4 justify-center">
              <a href="#" className="text-muted-foreground hover:text-primary transition-colors p-2">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 22.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.008 5.965h-1.83z"/></svg>
              </a>
              <a href="#" className="text-muted-foreground hover:text-primary transition-colors p-2">
          ...
          <div className="px-3 pb-6 pt-2 border-t border-border/30 mt-2">
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-semibold text-destructive hover:bg-destructive/10 transition-all min-h-[44px]"
            >
